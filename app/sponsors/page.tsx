...
const TIERS = [
  {
    ...
    price: 'PKR 600,000',
    badgeCls: 'bg-neutral-400 text-black',
    cardCls: 'border-neutral-400/30 bg-neutral-400/[0.03]',
    glowCls: 'shadow-[0_0_30px_rgba(163,163,163,0.08)]',
    benefits: [
  ...
  },
  {
    ...
    price: 'PKR 450,000',
    badgeCls: 'bg-violet-300 text-black',
    cardCls: 'border-violet-300/25 bg-violet-300/[0.02]',
    glowCls: 'shadow-[0_0_30px_rgba(196,181,253,0.07)]',
    benefits: [
  ...
  },
  {
    ...
    price: 'PKR 350,000',
    badgeCls: 'bg-cyan-200 text-black',
    cardCls: 'border-cyan-200/25 bg-cyan-200/[0.02]',
    glowCls: 'shadow-[0_0_30px_rgba(207,250,254,0.07)]',
    benefits: [
      { label: 'Stall Space',              value: 'YES – 3 Tables' },
      { label: 'Prime Stall Location',     value: 'YES' },
      { label: 'Social Media Marketing',   value: 'YES' },
  ...
  },
  {
    name: 'Silver Sponsor',
    price: 'PKR 150,000',
    badgeCls: 'bg-slate-400 text-black',
    cardCls: 'border-slate-400/20 bg-slate-400/[0.015]',
    glowCls: 'shadow-[0_0_30px_rgba(148,163,184,0.06)]',
    benefits: [
      { label: 'Stall Space',              value: 'YES – 2 Tables' },
      { label: 'Prime Stall Location',     value: 'NO' },
      { label: 'Social Media Marketing',   value: 'YES' },
